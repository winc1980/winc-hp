...
const weeks: CalendarDay[][] = [
  [
    ...
    { date: "4", dayOfWeek: 5, events: [{ label: "web体験会(後食事)", type: "social", time: "15:00~19:00", location: "未定" }] },
  ...
  [
    ...
    { date: "10", dayOfWeek: 4, events: [{ label: "エンジニア進路会", type: "social", time: "15:00~19:00", location: "学生会館E519" }] },
  ...
  [
    ...
    { date: "16", dayOfWeek: 3, events: [{ label: "web体験会(後食事)", type: "social", time: "15:00~19:00", location: "学生会館E519" }] },
    { date: "17", dayOfWeek: 4, events: [] },
    { date: "18", dayOfWeek: 5, events: [{ label: "女子会", type: "social", time: "15:00~19:00", location: "学生会館E519" }] },
    { date: "19", dayOfWeek: 6, events: [] },
  ],
  [
    { date: "4/20", dayOfWeek: 0, events: [] },
    { date: "21", dayOfWeek: 1, events: [] },
    { date: "22", dayOfWeek: 2, events: [{ label: "エンジニア進路会", type: "social", time: "15:00~19:00", location: "学生会館E519" }] },
  ...
  [
    ...
    { date: "28", dayOfWeek: 1, events: [{ label: "web体験会", type: "social", time: "15:00~19:00", location: "学生会館E519" }] },
